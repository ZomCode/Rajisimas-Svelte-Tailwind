            ...
            <div class="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-800 dark:text-gray-400">
                        ...
                        <li>
                            <a href="mailto:rajisimasconsabor@gmail.com.mx" class="hover:underline text-ellipsis overflow-hidden">{$_('footer.contactInfo.email')}: rajisimasconsabor@gmail.com</a>
                        </li>
                    </ul>
                </div>
                <div>

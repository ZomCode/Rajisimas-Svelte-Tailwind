...
<footer class="p-4 bg-gradient-to-b bg-gray-300 sm:p-6 dark:bg-gray-800">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-800 dark:text-gray-400">
                        ...
                        <li>
                            <a href="mailto:rajisimasconsabor@gmail.com.mx" class="hover:underline">{$_('footer.contactInfo.email')}: rajisimasconsabor@gmail.com</a>
                        </li>
                    </ul>
                </div>
                <div>

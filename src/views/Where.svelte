	...
	let sucursales = [
		{
			...
			sucursales: [
				...
				'Oxxo 117 Oriente',
				'Oxxo Sadasi',
				'Oxxo Heroes de Puebla II',
				'Oxxo Karpas Jardìn',
				'Oxxo España',
				'Oxxo El Portòn',
				'Oxxo Lomas del Marmol',
				'Oxxo Villas Carmel',
				'Oxxo Patrimonio',
				'Oxxo San Isidro',
				'Oxxo Geovillas',
				'Oxxo Oriòn',
				'Oxxo',
				'Oxxo Mateo del Regil',
				'Oxxo Plaza W',
				'Oxxo Pabellòn Atlixcayotl',
				'Oxxo Òpera',
				'Oxxo Sinfonìa',
				'Oxxo Gas Lomas',
				'Oxxo Lomas II',
				'Oxxo Lomas de Angelop',
				'Oxxo Aventura',
				'Oxxo Plaza del Arco',
				'Oxxo Hda. Santa Clara',
				'Oxxo Santa Isabel',
				'Oxxo Olivos',
				'Oxxo La Huerta',
				'Oxxo Plaza San Carlos',
				'Oxxo Xixitla',
				'Oxxo San Pedro',
				'Oxxo 4 caminos',
				'Oxxo Jerusalèn',
				...
				'Oxxo Campanario',
				'Oxxo Cañada',
				'Oxxo Cumbres Barreal',
				'Oxxo Bello Horizonte',
				'Oxxo Maya Norte',
				'Oxxo Morillotla',
				'Oxxo Plaza Arcoiris',
				'Oxxo Itzel',
				...
				'Oxxo',
				'Oxxo Casa Club',
				'Oxxo HaciendaSanCarlos',
				'Oxxo Floripa',
				'Oxxo El Marquès',
				'Oxxo El Rosal',
				'Oxxo San Juan',
				'Oxxo Bosques de Chapultepec',
				'Oxxo Nuevo Horizonte',
				'Oxxo del Valle',
				'Oxxo Real Campestre',
				'Oxxo Periferico Bosques',
				'Oxxo Xoxtla',
				'Oxxo Paseo Segovia',
				'Oxxo Segovia'
			]
...
<section class="flex flex-col py-4 gap-x-4 items-center md:justify-center dark:bg-zinc-800 bg-white">
	...
	<!-- <iframe src="https://www.google.com/maps/d/embed?mid=1OcA7MHYwefDy7Mzlzb3kaV5R3NswvE4&hl=es-419&ehbc=2E312F" width="640" height="480"></iframe> -->
